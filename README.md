...
### Brief Summary:
In this project, the classical MEAM potential by Choi et. al. (https://www.nature.com/articles/s41524-017-0060-9) was used to compute transport coefficients in CoNiCrFeMn high entropy alloys using the variational principle of mass transport (Dallas R. Trinkle, Phys. Rev. Lett., 2018). The repository contains code to generate necessary data sets using this potential as well as to train:
...
The various directories in this repository are described as follows:
...
## (2) Data Set generation - Directories "pot", "MEAM_MC" and "MEAM_KMC".
