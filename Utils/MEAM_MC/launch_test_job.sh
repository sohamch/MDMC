...
mkdir 1
cd 1
python3 ../../Init_state_MC.py -nosr -pp $potpath -T 1073 -etol 0.0 -ftol 0.001 -na 99 100 100 100 100 -nt 100 -ne 5 -ns 1 -dmp -dpf test_args_first_run.txt
...
python3 ../../Init_state_MC.py -etol 0.0 -ftol 0.001 -nosr -pp $potpath -T 1073 -ckp -nt 100 -ne 5 -ns 1 -dmp -dpf test_args_second_run.txt
