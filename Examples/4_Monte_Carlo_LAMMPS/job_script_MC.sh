...
# Runs from scratch
# We'll simulate 40 independent trajectories at 1073K, each starting from a random state, and every 250 states gathered from each trajectory.
# We will initialize 500 atom supercells with one vacancy (default option) and use 99, 100, 100, 100, 100 atoms of Co, Ni, Cr Fe and Mn
# respectively.
...
for i in {1..40} # For each jobID, we generate 16 trajectories with specified atom counts.
do
